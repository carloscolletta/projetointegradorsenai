...
<%String sql = "SELECT * FROM clientes WHERE cnpj = ".concat(cnpj); %>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="incluir_001.jsp" target="blank" class="paginas">NOVO CLIENTE<span class="sr-only">(Página atual)</span></a>
            </li>
    ...
    <% while(rs.next())
	{
     ...
     %>
    <form name="form_cliente" id="form_cliente" action="altera_003.jsp" form="POST" >
            ...
            <div class="grid_paginas"> 
                ...
                <div class="dados_pessoais_1">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td> 
                                   <input type="text" id="cnpj" name="cnpj" size="14"  value="<%=rs.getString("cnpj")%>" class="entrada" > 
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="razao_social" name="razao_social" size="60"  value="<%=rs.getString("razao_social")%>" class="entrada" > 
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input required type="email" name="email" value="<%=rs.getString("email")%>"  class="entrada" size="60" id="email">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input required type="password" name="pass" value="<%=rs.getString("pass")%>"  class="entrada" size="10" id="pass"> 
                            </td>
                        </tr>
               ...
               <div class="validar_form">
                ...
                <div class="enviar_cad">
                    <button type="submit" id="atualizar" class="btn btn-info btn-sm" >Atualizar</button>
                </div>
