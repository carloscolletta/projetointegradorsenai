...
String cnpj_cc = request.getParameter("cnpj");
cnpj_cc = cnpj_cc.replaceAll("\\.","");
cnpj_cc = cnpj_cc.replaceAll("\\-","");
cnpj_cc = cnpj_cc.replaceAll("\\/","");

String razao_social_cc = request.getParameter("razao_social");
String email_cc = request.getParameter("email");
String pass_cc  = request.getParameter("pass");

// instanciar classe Clientes
clientes cl = new clientes();

//Transferência dos conteúdos tratados dos formulários
// para os atributos do objeto "cli"

 cl.setcnpj_cc(cnpj_cc);
 cl.setrazao_social_cc(razao_social_cc);
 cl.setemail_cc(email_cc);
 cl.setpass_cc(pass_cc);
    ...
    <form name="form_cliente" id="form_cliente" >
        ...
        <section class="container">        
            ...
            <div class="grid_paginas"> 
                ...
                <tr>
                    <td> <h5> CLIENTE CADASTRADO</h5> </td>
                    <!-- <td></td> -->
                </tr>
                </div>
