...
String rs             = request.getParameter("razao_social");
...
cl.setcnpj_cc(cnpj_c);
cl.setrazao_social_cc(rs);
cl.setemail_cc(email_c);
cl.setpass_cc(pass_c);
            ...
            <div class="grid_paginas"> 
                ...
                <div class="dados_pessoais_1">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <label for="razao-social_c">Raz�o Social :</label> 
                            </td>
                            <td>
                                <%=rs%>
                            </td>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td>
                                <label for="pass_cc">Paasword :</label> 
                            </td>
                            <td>
                               <%=pass_c%>
                            </td>
                ...
                <tr>
                    <td> <h5> CLIENTE ATUALIZADO </h5> </td>
                    <!-- <td></td> -->
                </tr>
                </div>
